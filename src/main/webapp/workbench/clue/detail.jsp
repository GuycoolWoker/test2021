...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#bundBtn").click(bundBtn);

		// 为保存按钮绑定事件,执行备注的添加
		$("#save_clue_remark").click(save_clue_remark);
	});
		...
		$.ajax({
			...
			success:function (data){
				...
				$.each(data,function(i,n){
					...
					html += '<font color="gray">线索</font> <font color="gray">-</font> <b>"${applicationScope.c.fullname}${c.appellation}"-"${c.company}"</b> <small style="color: gray;"> "${c.editTime == null?c.createTime:c.editTime}" 由"${c.owner}"</small>';
	...
	function save_clue_remark(){
		$.ajax({
			url:"",
			type:"post",
			data:{
				noteContent:$("#clue_remark").val(),
	...
	function bundBtn(){
		...
		if($xz.length != 0){
			...
			if(confirm("确认关联吗?")){
				...
				// workbench/clue/bund.do?clueid=xxx&activityid=xxx&activityid=xxx...
...
<body>
					...
					<div class="btn-group" style="position: relative; top: 18%; left: 8px;">
						<form class="form-inline" role="form">
						  <div class="form-group has-feedback">
						    <input type="text" class="form-control" style="width: 300px;" placeholder="请输入市场活动名称，支持模糊查询" id="aname1" /><input type="button" value="查询" id="aname" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<div style="position: relative; top: 40px; left: 40px;">
		...
		<%--<div class="remarkDiv" style="height: 60px;">
			...
			<div style="position: relative; top: -40px; left: 40px;" >
				<h5>哎呦！</h5>
				<font color="gray">线索</font> <font color="gray">-</font> <b>${applicationScope.user.name}先生-动力节点</b> <small style="color: gray;"> 2017-01-22 10:10:10 由zhangsan</small>
		...
		<div id="remarkDiv" style="background-color: #E6E6E6; width: 870px; height: 90px;">
			<form role="form" style="position: relative;top: 10px; left: 10px;">
				<textarea id="remark" class="form-control" style="width: 850px; resize : none;" rows="2" id="clue_remark" placeholder="添加备注..."></textarea>
				<p id="cancelAndSaveBtn" style="position: relative;left: 737px; top: 10px; display: none;">
					<button id="cancelBtn" type="button" class="btn btn-default">取消</button>
					<button type="button" class="btn btn-primary" id="save_clue_remark">保存</button>
				</p>
			</form>
		</div>
	</div>
